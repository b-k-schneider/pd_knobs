...
// Send MIDI CC messages for all 13 knobs after the main loop runs this many times.
...
uint16_t prev_pot_val[13] = {0xffff, 0xffff, 0xffff, 0xffff, 0xffff, 0xffff, 0xffff,
                             0xffff, 0xffff, 0xffff, 0xffff, 0xffff, 0xffff};

// an array of potentiometer pins
uint8_t pot[13] = {POT01, POT02, POT03, POT04, POT05, POT06, POT07,
                   POT08, POT09, POT10, POT11, POT12, POT13};

// an array of CC numbers
uint8_t cc[13] = {CC01, CC02, CC03, CC04, CC05, CC06, CC07, CC08,
                  CC09, CC10, CC11, CC12, CC13};
